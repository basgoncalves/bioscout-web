...
const DYNAMIC = /^(cond_|why_|view_|var_|assessHow_|assessTest_|assessBand_|assessPart_|hudFrame_|assessBadFraming_|series_|qn_|sport_|bm_|pal_|rtInput_|rtGame_|rtHow_|rtCol_|sumChart_|sumWin_|energyFrom_|activity_|goal_|asm_m_|asmWin_|jl_)/;
m.setLang("en");
